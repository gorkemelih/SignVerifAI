...
def train(
    ...
    embedding_dim: int = typer.Option(256, help="Embedding dimension"),
    pretrained: bool = typer.Option(True, help="Use pretrained backbone"),
    freeze_epochs: int = typer.Option(5, help="Freeze backbone for N epochs"),
    backbone_lr: float = typer.Option(3e-5, help="Backbone learning rate"),
    head_lr: float = typer.Option(5e-4, help="Head learning rate"),
    loss: str = typer.Option("contrastive", help="Loss: contrastive, triplet, arcface, or hybrid"),
